...
2. [Download the jar](https://github.com/buremba/rakam-android/raw/master/rakam-android-2.7.2-with-dependencies.jar) and copy it into the "libs" folder in your Android project in Android Studio.

  Alternatively, if you are using Maven in your project, the jar is available on [Maven Central](http://search.maven.org/#artifactdetails%7Cio.rakam%7Candroid-sdk%7C2.7.2%7Cjar) using the following configuration in your pom.xml:
  ...
  Or if you are using gradle in your project, include in your build.gradle file:
    ...
    ```
    compile 'io.rakam:android-sdk:2.7.2'
    ```
