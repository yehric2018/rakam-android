...
public class Revenue {
    ...
    /**
     * The class identifier tag used in logging. TAG = {@code "io.rakam.api.Revenue"}
     */
    public static final String TAG = "io.rakam.api.Revenue";
     ...
     * @return the same Revenue object
     * @see <a href="https://github.com/rakam/Rakam-Android#setting-event-properties">
