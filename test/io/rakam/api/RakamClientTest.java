...
public class RakamClientTest extends BaseTest {
    ...
    public void testLog3Identifys() throws JSONException {
        ...
        assertTrue(compareJSONObjects(
                events.optJSONObject(1).optJSONObject("data"), expectedIdentify2
        ));
        assertTrue(compareJSONObjects(
                events.optJSONObject(2).optJSONObject("data"), expectedIdentify3
        ));
    ...
    public void testUploadRemainingEvents() {
        ...
        rakam.uploadingEventsCurrently.set(true); // block uploading until we queue up enough events
        for (int i = 0; i < 6; i++) {
        ...
        rakam.uploadingEventsCurrently.set(false);
